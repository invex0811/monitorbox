...
const TimeCalculator = () => {
    ...
    const calculateTime = () => {
        ...
        let newDate2 = DateTime.fromFormat(
            lowTimestamp,
            "dd-MMM-yyyy HH:mm:ss"
        );
        let diff = newDate
            ...
            >
                ...
                >
                    <TextField
                        ...
                        label={"Height time"}
                        onChange={(event) =>
                            setHeightTimestamp(event.target.value)
                        }
                        sx={{
                            margin: " 0 5px 7px 0",
                        }}
                    ...
                    <TextField
                        ...
                        label={"Low time"}
                        onChange={(event) =>
                            setLowTimestamp(event.target.value)
                        }
                        sx={{
                            marginRight: "5px",
                        }}
                ...
                >
                    <TextField
                        ...
                        label={"Height TEH"}
                        onChange={(event) =>
                            setHeightTEH(Number(event.target.value))
                        }
                        sx={{
                            margin: "0 0 7px 5px",
                        }}
                    ...
                    <TextField
                        ...
                        label={"Low TEH"}
                        onChange={(event) =>
                            setLowTEH(Number(event.target.value))
                        }
                        sx={{
                            marginLeft: "5px",
                        }}
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            ...
                            checked={TEHCheckbox}
                            onChange={(event) =>
                                setTEHCheckbox(event.target.checked)
                            }
                        />
                    }
                    label="Show TEH"
