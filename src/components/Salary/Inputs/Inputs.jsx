        ...
        >
            ...
            >
                <Box sx={{ display: "flex" }}>
                    ...
                    />
                    <FormControl
                        sx={{ margin: "7px 0 7px 7px", width: "100%" }}
                    >
                ...
                <TableContainer>
                    ...
                    <Table>
                        <TableBody>
                            ...
                            {/*</TableRow>*/}
                            <TableRow
                                sx={{ display: moneyUAH > 0 ? "" : "none" }}
                            >
                                <TableCell>USD rate:</TableCell>
                                <TableCell sx={{ color: "#01e01f" }}>
                                    {dollarRate}
                                </TableCell>
                            </TableRow>
                            <TableRow
                            ...
                            >
                                ...
                                <TableCell>
                                    {Number(moneyUAH).toFixed(2)}
                                </TableCell>
                            </TableRow>
                            <TableRow
                                sx={{
                                    display: fivePercentTaxCheckbox
                                        ? ""
                                        : "none",
                                }}
                            >
